...
<a class="navbar-brand" href="#">MENU PRINCIPAL </a>
    ...
    <a class="navbar-brand" href="#">FECHAS DISPONIBLES</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">SERVICIOS AÑADIDOS</h5>
...
<div class="card m-4" style="width: 18rem;">
        <form id="formulario" name="formulario" method="post" action="cart.php">
            <input name="precio" type="hidden" id="precio" value="3000" />
            <input name="titulo" type="hidden" id="titulo" value="articulo 1" />
            <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
            <img src="img/salon.png" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Salon</h5>
                        <p class="card-text">Salon - Precio $3000</p>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="img/mobiliario.png" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Mobiliario</h5>
                        <p class="card-text">Mobiliario  - Precio $2000</p>
                        <button class="btn btn-primary" type="submit" ><i class="fas fa-shopping-cart"></i> Añadir al carrito</button>
                </div>
        </form>
</div>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="img/sonido.png" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Sonido</h5>
                        <p class="card-text">Sonido - Precio 1500</p>
                        <button class="btn btn-primary" type="submit" ><i class="fas fa-shopping-cart"></i> Añadir al carrito</button>
                </div>
        </form>
</div>
